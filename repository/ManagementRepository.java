...
public class ManagementRepository implements ManagementRepositoryImpl {
    ...
    private static final String update_student_set="update teacher set ";
    ...
    public String updateSingleTeacher(Teacher teachers) {
        ...
        try{
            ...
            if(teachers.getName()!=null&& teachers.getEmail()!=null){
                count=st.executeUpdate(update_student_set+"name='"+teachers.getName()+"',email='"+teachers.getEmail()+"'"+where_id+teachers.getId()+"'");
            }
            else {
                if(teachers.getName()!=null){
                    count=st.executeUpdate(update_student_set+"name='"+teachers.getName()+"'"+where_id+teachers.getId()+"'");
                }
                else {
                    count=st.executeUpdate(update_student_set+"email='"+teachers.getEmail()+"'"+where_id+teachers.getId()+"'");
                }
            }
            if(count>0){
