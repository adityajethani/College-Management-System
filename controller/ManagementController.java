...
public class ManagementController {
    ...
    String registerTeacher(@RequestBody Teacher teachers){
        return service1.registerTeacher(teachers);
    }
    @RequestMapping("/create-multiple-teacher")
    @ResponseBody
    String createMultipleTeacher(@RequestBody List<Teacher> teacher) {
        return service1.createMultipleTeacher(teacher);
    }
    ...
    @RequestMapping("/update-single-management-himself")
    @ResponseBody
    String updateSingleManagementHimself(@RequestBody Management managements){
        return service2.updateSingleManagement(managements);
    }
    @RequestMapping("/read-single-management-himself")
    @ResponseBody
    Management readSingleManagementHimself(@RequestParam int id){
