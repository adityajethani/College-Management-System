        ...
        try{
            ...
            if(managements.getName()!=null&& managements.getEmail()!=null){
                ...
                if(managements.getName()!=null){
                    ...
                    count=st.executeUpdate(update_management_set+"email='"+managements.getEmail()+"'"+where_id+managements.getId()+"'");
                }
            }
            if(count>0){
    ...
    public String updateSingleAdmin(Admin admins) {
        ...
        try{
            ...
            if(admins.getName()!=null&& admins.getEmail()!=null){
                count=st.executeUpdate(update_admin_set+"name='"+admins.getName()+"',email='"+admins.getEmail()+"'"+where_id+admins.getId()+"'");
            }
            else {
                if(admins.getName()!=null){
                    count=st.executeUpdate(update_admin_set+"name='"+admins.getName()+"'"+where_id+admins.getId()+"'");
                }
                else {
                    count=st.executeUpdate(update_admin_set+"email='"+admins.getEmail()+"'"+where_id+admins.getId()+"'");
                }
            }
            if(count>0){
                result=updateMessage;
