...
public class TeacherController {
    ...
    @RequestMapping("/update-single-teacher-himself")
    @ResponseBody
    String updateSingleTeacherHimself(@RequestBody Teacher teachers){
        return service1.updateSingleTeacher(teachers);
    }
    @RequestMapping("/read-single-teacher-himself")
    @ResponseBody
    Teacher readSingleTeacherHimself(@RequestParam int id){
